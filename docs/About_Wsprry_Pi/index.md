...
6. Today we have direct-output planning, not implemented or qualified harmonic operation. Harmonic operations are a feasible development direction; usable power, spectral cleanliness, and modulation quality remain to be measured.
7. Pi 5 PLL_SYS results on 6 m (50.294500 MHz) and 4 m (70.092500 MHz) did not establish band qualification, although DFCW passed 3/3 observations on both. On 6 m, TONE residual variation was 2.596 Hz, WSPR decoded 2/3 frames (the first had no decode), QRSS had a 2.174 Hz residual on the third observation, and FSKCW drift excursion was 3.620 Hz. On 4 m, TONE offset was −292.21 Hz with a 3.227 Hz residual; WSPR offset was −306.51 Hz and frames were not run; QRSS had a 2.466 Hz residual on the first observation; and FSKCW drift excursion was 3.731 Hz.
