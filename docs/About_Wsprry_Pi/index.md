...
8. On 6 m, the BCM2711 750 MHz PLLD profile is qualified for TONE, QRSS, and FSKCW. QRSS passed three independently captured keyed repetitions. FSKCW passed three independently captured shifted-tone repetitions with median separations of 4.574, 5.047, and 5.007 Hz. DFCW remains unqualified because the closing carrier control after its corrective captures exceeded the ±100 Hz gate. WSPR produced two consecutive correct decodes, short of the three required, and remains unqualified. The profile is therefore Partial.
