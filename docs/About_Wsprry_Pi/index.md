...
2. GPIO transmission on 12 m did not meet the WSPR decode requirement with 500 MHz or 750 MHz PLLD on the Pi 1-4.
...
5. The current planner cannot construct 1.25 m or 70 cm output. Experimental overrides cannot enable unavailable combinations.
